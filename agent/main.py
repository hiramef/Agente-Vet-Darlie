...
app = FastAPI(
    title="AgentKit — Veterinaria Darlie",
    version="1.0.0",
    lifespan=lifespan
)
...
async def health_check():
    return {"status": "ok", "service": "agentkit", "negocio": "Veterinaria Darlie"}
...
async def webhook_handler(request: Request):
    try:
        ...
        for msg in mensajes:
            ...
            # Pasar el teléfono para que brain.py lo inyecte al registrar citas
